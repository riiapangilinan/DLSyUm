...
## Description
DLSyUm is a comprehensive web application designed to provide users with an interactive platform to review and 
discover restaurants. Users can browse through various establishments, read detailed reviews, and contribute 
...
## Installing from MacOS Terminal
...
In our case it's
    > `node /Users/riialindseypangilinan/Downloads/Grp7_MCO3/server.js ` 
...
## Authors
> Acosta, Axel Toby S.
> Cosue, Alexis Maureen D.
> Pangilinan, Riia Lindsey G.
> Punongbayan, Richard Daniel D.
